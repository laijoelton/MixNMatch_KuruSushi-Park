...
_routes("POST", ("/api/manual/barrier/[^/]+/(?:open|close)", "/api/barriers/[^/]+/(?:open|close)", "/api/ghost-cars/[0-9]+/override", "/api/ghost-car/override", "/api/ghost-cars/[0-9]+/release"), "ops:control_gates")
