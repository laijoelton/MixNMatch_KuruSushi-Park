...
_routes("GET", ("/api/broken", "/api/wear"), "maint:view")
_routes("POST", ("/api/sessions/[^/]+/request-payment", "/api/gates/(?:open-all|auto-all)"), "ops:control_gates")
...
_routes("GET", ("/api/admin/audit", "/api/signature-report", "/security", "/api/security"), "logs:view_audit")
# Incidents are operational, not privileged: the people watching the site are
# the ones who have to act on a double-parked car.
_routes("GET", ("/api/incidents",), "ops:view")
